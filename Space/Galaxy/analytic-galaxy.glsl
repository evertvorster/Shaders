...
// GENERATED by Tools/build_galaxy.py via Tools/shader_build.py from /home/evert/Software/Projects/Shaders/Space/Galaxy/analytic-galaxy.frag -- do not edit by hand.
...
void main() {
	...
	vec3 transmittance;
	vec3 col = vec3(0.0);
	col = galaxySky(uCamPos, dir, pxPerDir, transmittance);
