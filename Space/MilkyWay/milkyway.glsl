...
// GENERATED by Tools/build_milkyway.py via Tools/shader_build.py from /home/evert/Software/Projects/Shaders/Space/MilkyWay/milkyway.frag -- do not edit by hand.
...
void main() {
	...
	vec3 transmittance;
	vec3 col = vec3(0.0);
	col = milkywaySky(dir, pxPerDir, transmittance);
