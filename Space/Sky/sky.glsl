...
// GENERATED by Tools/build_sky.py via Tools/shader_build.py from /home/evert/Software/Projects/Shaders/Space/Sky/sky.frag -- do not edit by hand.
...
void main() {
	...
	vec3 transmittance;
	vec3 col = vec3(0.0);
	col = skyColour(uCamPos, dir, pxPerDir, dither, transmittance);
