...
// GENERATED by Tools/build_nebula.py via Tools/shader_build.py from /home/evert/Software/Projects/Shaders/Space/Nebula/ridged-clouds.frag -- do not edit by hand.
...
void main() {
	...
	vec3 transmittance;
	vec3 col = vec3(0.0);
	col = nebulaSky(uCamPos, dir, pxPerDir, dither, transmittance);
